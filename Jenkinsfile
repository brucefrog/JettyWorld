node {
    ...
    if (env.BRANCH_NAME == 'master') {
			...
			def dkrDistCfg = [
			    ...
			    'gpgPassphrase'         : '', // If specified, Artifactory will GPG sign the build deployed to Bintray and apply the specified passphrase.
			    'async'                 : true, // Default: false. If true, the build will be distributed asynchronously. Errors and warnings may be viewed in the Artifactory log.
